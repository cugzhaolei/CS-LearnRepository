# [Design Pattern](http://c.biancheng.net/view/1317.html)

设计模式是一套反复使用，多数人知晓、经过分类编目、代码设计经验的总结，1995年由GoF在《设计模式：可复用面向对象软件的基础》（Design Patterns: Elements of Reusable Object-Oriented Software）一书中提出
...
unified modeling language 统一建模语言，是用来设计软件蓝图的可视化建模语言，1997 年被国际对象管理组织（OMG）采纳为面向对象的建模语言的国际标准。它的特点是简单、统一、图形化、能表达软件设计中的动态与静态信息。
...
![class](/images/designPattern-basicInfo-uml-class.gif)

2. 接口
接口（Interface）是一种特殊的类，它具有类的结构但不可被实例化，只可以被子类实现。它包含抽象操作，但不包含属性。它描述了类或组件对外可见的动作。在 UML 中，接口使用一个带有名称的小圆圈来进行表示。

![interface](/iamges/designPattern-basicInfo-uml-interface.gif)
...
![classPicture](/images/designPattern-basicInfo-classPicture.gif)
...
![dependecy](/images/designPattern-basicInfo-classPicture-dependency.gif)
...
![](/images/designPattern-basicInfo-classPicture-association.gif)
...
![aggregation](/images/designPattern-basicInfo-classPicture-aggregation.gif)
...
![composition](/images/designPattern-basicInfo-classPicture-composition.gif)
...
![generalization](/images/designPattern-basicInfo-classPicture-generalization.gif)
...
![realizaiton](/images/designPattern-basicInfo-classPicture-realization.gif)
...
![openclosedPrinciple](/images/designPattern-basicInfo-OOP-Principle-OpenCLosedPrinciple.gif)
...
![LSP](/images/designPattern-basicInfo-OOP-Principle-LiskovSubstitutionPrinciple.gif)
...
![LSP-example](/images/designPattern-basicInfo-OOP-Principle-OpenCLosedPrinciple-example-bird.jpg)
...
![DIP](/images/designPattern-basicInfo-OOP-Principle-DependencyInversionPrinciple.gif)
...
![SRP](/images/designPattern-basicInfo-OOP-Principle-SingleResponsibilityPrinciple.gif)
...
![InterfaceSegregationPrinciple](/images/designPattern-basicInfo-OOP-Principle-InterfaceSegregationPrinciple.gif)
...
![DemeterPrinciple](/images/designPattern-basicInfo-OOP-Principle-DemeterPrinciple.gif)
...
![CompositionReusePrinciple](/images/designPattern-basicInfo-OOP-Principle-CompositionReusePrinciple.jpg)

从图 1 可以看出用继承关系实现会产生很多子类，而且增加新的“动力源”或者增加新的“颜色”都要修改源代码，这违背了开闭原则，显然不可取。但如果改用组合关系实现就能很好地解决以上问题，其类图如图 2 所示。

![example](/images/designPattern-basicInfo-OOP-Principle-CompositionReusePrinciple-useComposition.gif)
...
![singleton](/images/designPattern-basicInfo-OOP-Principle-singleton-structure.gif)
...
![lazysingleton](/images/designPattern-basicInfo-OOP-Principle-singlton-lazy.gif)
...
![hungry](/images/designPattern-basicInfo-OOP-Principle-singlton-hungry.gif)
...
![multicm](/images/designPattern-basicInfo-OOP-Principle-singlton-multicm.gif)
...
![prototype](/iamge/designPattern-basicInfo-OOP-Principle-prototype.gif)
...
![example](/images/designPattern-basicInfo-OOP-Principle-prototype-example.gif)
...
![generate](/images/designPattern-basicInfo-OOP-Principle-prototype-generateResemble.gif)
...
![extend](/images/designPattern-basicInfo-OOP-Principle-prototype-extend.gif)

【例3】用带原型管理器的原型模式来生成包含“圆”和“正方形”等图形的原型，并计算其面积。分析：本实例中由于存在不同的图形类，例如，“圆”和“正方形”，它们计算面积的方法不一样，所以需要用一个原型管理器来管理它们，图 6 所示是其结构图。

![shape](/images/designPattern-basicInfo-OOP-Principle-prototype-example-shape.gif)
...
本节介绍的“工厂方法模式”是对简单工厂模式的进一步抽象化，其好处是可以使系统在不修改原来代码的情况下引进��的产品，即满足开闭原则。
...
![factory](/images/designPattern-basicInfo-OOP-Principle-factory.gif)
...
![farm](/images/designPattern-basicInfo-OOP-Principle-factory-farm.gif)
...
![simpleFactory](/images/designPattern-basicInfo-OOP-Principle-simpeFactory.gif)
...
![electricFactory](/images/designPattern-basicInfo-OOP-Principle-Electricfactory.gif)
...
![abstractFactory](/images/designPattern-basicInfo-OOP-Principle-abstractFactory.gif)
...
![simpleFactory](/images/designPattern-basicInfo-OOP-Principle-simpeFactory-farm.gif)
...
![builder](/images/designPattern-basicInfo-OOP-Principle-builder.gif)
...
![builder-exmaple](/images/designPattern-basicInfo-OOP-Principle-builder-example.gif)
...
![proxy](/images/designPattern-basicInfo-OOP-Principle-ProxyConstructor.gif)
...
![proxy](/images/designPattern-basicInfo-OOP-Principle-ProxyConstructor-example.gif)
...
![proxyExtend](/images/designPattern-basicInfo-OOP-Principle-ProxyConstructor-extend.gif)
...
![adaptor](/images/designPattern-basicInfo-OOP-Principle-adaptor.gif)

对象适配器模式的结构图如图 2 所示。

![object adaptor](/images/designPattern-basicInfo-OOP-Principle-adaptor-object.gif)
...
![example](/images/designPattern-basicInfo-OOP-Principle-adaptor-object-example.gif)
...
注意：如果将配置文件中的 ElectricAdapter 改为 
::: tip
OpticalAdapter，则运行结果如下：
适配器模式测试：
光能发动机驱动汽车！
:::
...
![doubleAdaptor](/images/designPattern-basicInfo-OOP-Principle-doucleAdaptor.gif)
...
![bridge](/images/designPattern-basicInfo-OOP-Principle-bridge.gif)
...
![example](/images/designPattern-basicInfo-OOP-Principle-bridge-example.gif)
...
![bridgeAndAdaptor](/images/designPattern-basicInfo-OOP-Principle-bridgeAndAdaptor.gif)
...
![decorator](/images/designPattern-basicInfo-OOP-Principle-decorator.gif)
...
![decorator](/images/designPattern-basicInfo-OOP-Principle-decorator-example.gif)
...
![no-extend](/images/designPattern-basicInfo-OOP-Principle-decorator-extend-noAbstractConstruct.gif)

(2) 如果只有一个具体装饰时，可以将抽象装饰和具体装饰合并，其结构图如图 5 所示。

![oneDecoration](/images/designPattern-basicInfo-OOP-Principle-decorator-oneDecoration.gif)
...
![facede](/images/designPattern-basicInfo-OOP-Principle-facede.gif)
...
![implementationOfFacede](/images/designPattern-basicInfo-OOP-Principle-facede-implementation.gif)
...
外观类（WySpecialty）用 JTree 组件来管理婺源特产的名称，并定义一个事件处理方法 valueChanged(TreeSelectionEvent e)，当用户从树中选择特产时，该特产的图标对象保存在标签（JLabd）对象中。

客户窗体对象用分割面板来实现，左边放外观角色的目录树，右边放显示所选特产图像的标签。其结构图如图 3 所示。

![facede-example](/images/designPattern-basicInfo-OOP-Principle-facede-example.gif)
...
![extend](/images/designPattern-basicInfo-OOP-Principle-facede-extend.gif)
...
图 1 是享元模式的结构图。图中的 UnsharedConcreteFlyweight 是非享元角色，里面包含了非共享的外部状态信息 info；而 Flyweight 是抽象享元角色，里面包含了享元方法 operation(UnsharedConcreteFlyweight state)，非享元的外部状态以参数的形式通过该方法传入；ConcreteFlyweight 是具体享元角色，包含了关键字 key，它实现了抽象享元接口；FlyweightFactory 是享元工厂角色，它利用关键字 key 来管理具体享元；客户角色通过享元工厂获取具体享元，并访问具体享元的相关方法。

![flyweight](/images/designPattern-basicInfo-OOP-Principle-flyweight.gif)
...
![example](/images/designPattern-basicInfo-OOP-Principle-flyweight-example.gif)
...
![pureFlyweight](/images/designPattern-basicInfo-OOP-Principle-flyweight-pure.gif)

(2) 复合享元模式，这种享元模式中的有些享元对象是由一些单纯享元对象组合而成的，它们就是复合享元对象。虽然复合享元对象本身不能共享，但它们可以分解成单纯享元对象再被共享，其结构图如图 5 所示。

![composition](/images/designPattern-basicInfo-OOP-Principle-flyweight-composition.gif)
...
![composition](/images/designPattern-basicInfo-OOP-Principle-compositionPattern.gif)
...
![safe](/images/designPattern-basicInfo-OOP-Principle-compositionPattern-safe.gif)

2. 模式的实现

假如要访问集合 c0={leaf1,{leaf2,leaf3}} 中的元素，其对应的树状图如图 3 所示。

![leaf](/images/designPattern-basicInfo-OOP-Principle-compositionPattern-leaf.gif)
...
![useSafe](/images/designPattern-basicInfo-OOP-Principle-compositionPattern-UseSafe.gif)
...
![complexComposition](/images/designPattern-basicInfo-OOP-Principle-compositionPattern-ComplexComposition.gif)
...
![observer](/images/designPattern-basicInfo-OOP-Principle-observer.gif)
...
![observer](/images/designPattern-basicInfo-OOP-Principle-observer-example.gif)
...
![clock](/images/designPattern-basicInfo-OOP-Principle-adaptor-observer-clock.gif)
...
![oil](/images/designPattern-basicInfo-OOP-Principle-observer-oil.gif)
...
![meditator](/images/designPattern-basicInfo-OOP-Principle-mediator.gif)
...
然后，定义一个客户（Customer）类，它是抽象同事类，其中包含了中介者的对象，和发送信息的 send(String ad) 方法与接收信息的 receive(String from，Stringad) 方法的接口，由于本程序是窗体程序，所以本类继承 JPmme 类，并实现动作事件的处理方法 actionPerformed(ActionEvent e)。

最后，定义卖方（Seller）类和买方（Buyer）类，它们��具体同事类，是客户（Customer）类的子类，它们实现了父类中的抽象方法，通过中介者类进行信息交流，其结构图如图 2 所示。

![meditator-estate](/images/designPattern-basicInfo-OOP-Principle-mediator-estate.gif)
...
![mediator-extend](/images/designPattern-basicInfo-OOP-Principle-mediator-extend.gif)
...
![interpreter](/images/designPattern-basicInfo-OOP-Principle-interpreter-student.gif)
...
![interpreter](/images/designPattern-basicInfo-OOP-Principle-interpreter.gif)
...
![example](/images/designPattern-basicInfo-OOP-Principle-interpreter-example.gif)
...
![aggregate](/images/designPattern-basicInfo-OOP-Principle-aggregate.gif)
...
![example](/images/designPattern-basicInfo-OOP-Principle-aggregate-example.gif)
...
![composition](/images/designPattern-basicInfo-OOP-Principle-aggregate-composition.gif)
...
![template](/images/designPattern-basicInfo-OOP-Principle-template.gif)
...
![example](/images/designPattern-basicInfo-OOP-Principle-template-abroad.gif)
...
![template](/images/designPattern-basicInfo-OOP-Principle-template-example.gif)
...
![designPattern-basicInfo-OOP-Principle-Strategy](/images/designPattern-basicInfo-OOP-Principle-Strategy.gif)
...
![example](/images/designPattern-basicInfo-OOP-Principle-strategy-crab.gif)
...
![visit](/images/designPattern-basicInfo-OOP-Principle-strategy-visit.gif)
...
![factoryStrategy](/images/designPattern-basicInfo-OOP-Principle-factoryStrategy.gif)
...
![command](/images/designPattern-basicInfo-OOP-Principle-command.gif)
...
首先，定义一个早餐类（Breakfast），它是抽象命令类，有抽象方法 cooking()，说明要做什么；再定义其子类肠粉类（ChangFen）、馄饨类（HunTun）和河粉类（HeFen），它们是具体命令类，实现早餐类的 cooking() 方法，但它们不会具体做，而是交给具体的厨师去做；具体厨师类有肠粉厨师（ChangFenChef）、馄蚀厨师（HunTunChef）和河粉厨师（HeFenChef），他们是命令的接收者，由于本实例要显示厨师做菜的效果图（[点此下载要显示的效果图](http://c.biancheng.net/uploads/soft/181113/3-1Q116125200.zip)），所以把每个厨师���定义为 JFrame 的子类；最后，定义服务员类（Waiter），它接收客户的做菜请求，并发出做菜的命令。客户类是通过服务员类来点菜的，图 2 所示是其结构图。

![dinning](/images/designPattern-basicInfo-OOP-Principle-command-dinning.gif)
...
![commposition](/images/designPattern-basicInfo-OOP-Principle-command-composition.gif)
...
![umlet](/images/designPattern-basicInfo-uml-umlet.jpg)
...
![umlClassPicture](/images/designPattern-basicInfo-uml-classPicture.gif)
...
![classRelation](/images/designPattern-basicInfo-uml-classRelation.gif)
