...
``` js
PS C:\Users\Administrator\Desktop\CV\learn\node-test> node
> global.console
Console {
...
var rs2 = fs2.createReadStream('sample.txt');
var ws2 = fs2.createWriteStream('copied.txt');
```
rs.pipe(ws);
...
#### 参考源码
http服务器代码（含静态网站）https://github.com/michaelliao/learn-javascript/tree/master/samples/node/http
