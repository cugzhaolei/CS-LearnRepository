...
* [vue2.0 key的作用](https://calendar.perfplanet.com/2013/diff/)
...
* <b>需要使用key来给每个节点做一个唯一标识，Diff算法就可以正确的识别此节点，找到正确的位置区插入新的节点</b>。

所以一句话，<b>key的作用主要是为了高效的更新虚拟DOM</b>。另外vue中在使用相同标签名元素的过渡切换时，也会使用到key属性，其目的也是为了让vue可以区分它们，
...
## [Vue3.0新特性](https://juejin.im/post/5bb719b9f265da0ab915dbdd)
